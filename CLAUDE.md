...
- `foreman/` - Contains Foreman provisioning orchestration design documentation
- `installer/` - Comprehensive foreman-installer documentation including Kafo framework, container deployment patterns, and installation workflows
- `smart-proxy/` - Smart proxy architecture documentation (overview, development setup, plugin architecture)
- `puppet-iop/` - IoP (Insights-on-Prem) architecture documentation
- Empty directories for: `katello/`, `foreman_remote_execution/`, `foreman_rh_cloud/`, `forklift/`, `hammer-cli/`
